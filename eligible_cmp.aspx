<%@ Page Title="" Language="C#" MasterPageFile="~/master_user.master" AutoEventWireup="true" CodeFile="eligible_cmp.aspx.cs" Inherits="eligible_cmp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:MultiView ID="MultiView_cmp_reg" runat="server" ActiveViewIndex="0">
  ...
  <hr />
        <center><h1>List of Eligible Companies</h1></center>
        <hr />
