<%@ Page Title="" Language="C#" MasterPageFile="~/master_user.master" AutoEventWireup="true" CodeFile="fac_group_basic.aspx.cs" Inherits="fac_group_basic" %>
                ...
                <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" TextMode="SingleLine" Visible="false" Width="300px"></asp:TextBox>
                        </td>
                        <td>
